...
var IDTECommerceAnalytics = /** @class */ (function () {
     ...
     * @returns Promise
     */
    IDTECommerceAnalytics.prototype.onCouponEntered = function (order_id, cart_id, coupon_id) {
        var payload = {
            order_id: order_id,
            cart_id: cart_id,
            coupon_id: coupon_id
     ...
     * @returns Promise
     */
    IDTECommerceAnalytics.prototype.onCouponApplied = function (order_id, cart_id, coupon_id, coupon_name, discount) {
        var payload = {
            order_id: order_id,
            cart_id: cart_id,
            coupon_id: coupon_id,
     ...
     * @returns Promise
     */
    IDTECommerceAnalytics.prototype.onCouponRemoved = function (order_id, cart_id, coupon_id, coupon_name, discount) {
        var payload = {
            order_id: order_id,
            cart_id: cart_id,
            coupon_id: coupon_id,
     ...
     * @returns Promise
     */
    IDTECommerceAnalytics.prototype.onCouponDenied = function (order_id, cart_id, coupon_id, coupon_name, reason) {
        var payload = {
            order_id: order_id,
            cart_id: cart_id,
            coupon_id: coupon_id,
